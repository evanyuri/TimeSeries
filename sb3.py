...
class G:
    ...
    BATCH_SIZE = 3 # how many items will we supply per batch
...
# print(type(batch))
# print(batch)
for i in range(n_prediction_points):   ##why no i used?
...
# print(G.SERIES)
ints = len(G.SERIES)
future_indicies = np.arange(ints, ints + n_prediction_points, 1, dtype=int)
# print(future_indicies)

# scaler = MinMaxScaler()

plt.plot(G.TIME, G.SERIES, label="last 100 points of time series")
